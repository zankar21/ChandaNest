...
exports.EnterpriseMemberUpdateSchema = exports.EnterpriseMemberCreateSchema = exports.EnterpriseCreateSchema = void 0;
const zod_1 = require("zod");
const memberships_schemas_1 = require("../memberships/memberships.schemas");
exports.EnterpriseCreateSchema = zod_1.z.object({
...
exports.EnterpriseMemberCreateSchema = zod_1.z.object({
    userId: zod_1.z.string().min(1),
    role: memberships_schemas_1.EnterpriseRoleSchema,
    status: memberships_schemas_1.MembershipStatusSchema.optional().default("active")
});
exports.EnterpriseMemberUpdateSchema = zod_1.z.object({
    role: memberships_schemas_1.EnterpriseRoleSchema.optional(),
